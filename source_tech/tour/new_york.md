...
<html>
    ...
    <body style="background-color: #F4F9F7;">
        <div class="guide">
            <div class="item"><img src="https://s21.ax1x.com/2024/06/16/pkwYuy8.png" style="padding-left: 10px;">
                Tour
            ...
            <div class="item"><img src="https://s21.ax1x.com/2024/06/16/pkwYQeg.png"><button onclick="">Camera</button></div>
        ...
        <div class="content" id="content">
            ...
            <div class="pic">
                <img src="https://s21.ax1x.com/2024/06/16/pkwYZWt.png" style="right: 30px;">
            </div>
            <div>
                <br>
            ...
            <div class="pic">
                <img src="https://s21.ax1x.com/2024/06/16/pkwJzz6.png" style="left: 30px;">
            </div>
            <div class="text">
                <br>
        ...
        <div id="pictures"></div>
        <div class="back">
            <a href="index.html"><img src="https://s21.ax1x.com/2024/06/16/pkwJxRx.png"> Back</a>
        </div>
        <style>
            .guide{
                position: sticky;
