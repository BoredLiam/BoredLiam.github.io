            ...
            var d = function(n) {
                ...
                b = function(e, t, n) {
                    ...
                    var a = s.cfg.friends.includes((0, j.default)(e.get("mail").toLowerCase())),
                        ...
                        u = (V.hide ? "" : s.cfg.enableQQ && e.get("QQAvatar") ? (0, U.default)('<img class="vimg" src="' + (y(e.get("QQAvatar"))) + '" referrerPolicy="no-referrer"/>') : '<img class="vimg" src="' + (QQ_img) + '">') 
                        + '<div class="vh"><div class="vhead">' + a + " " + i + '</div><div class="vmeta"><span class="vtime" >' + (0, R.default)(e.get("insertedAt"), s.i18n) + '</span><span class="vat" data-vm-id="' + (e.get("rid") || e.id) + '" data-self-id="' + e.id + '">' + s.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + s.i18n.t("expand") + '">' + (0, N.default)(e.get("comment")) + '</div><div class="vreply-wrapper" data-self-id="' + e.id + '"></div><div class="vquote" data-self-id="' + e.id + '"></div></div>',
