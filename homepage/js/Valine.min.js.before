      ...
      function (e, t, n) {
        ...
        (t.DEFAULT_EMOJI_CDN =
          ...
          (t.defaultConfig = {
            ...
            appKey: "",
            clazzName: "Comment",
            master: '4cb070c369cf2df4cb51fcb732a61a71',
            friends: ['9f82ada0f029aa91f29bf3732d0f5b49',''],
            tagMeta: ["博主", "小伙伴", "访客"],
            metaPlaceholder: {
              nick: "昵称(必填)",
              mail: "QQ号对应邮箱(必填,QQ号+@qq.com)",
              link: "网址(https://)",
            },
            meta: ["nick", "mail", "link"],
